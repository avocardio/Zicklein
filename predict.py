...
PROMPT = "Unten steht eine Anweisung, die eine Aufgabe beschreibt. Schreiben Sie eine Antwort, die die Anforderung angemessen erfüllt.\n\n### Anleitung:\n{instruction}\n\n### Antwort:"
...
class Predictor(BasePredictor):
    ...
    def predict(
        self,
        prompt: str = Input(description=f"Instruction to send to the finetuned german LLaMA."),
        n: int = Input(
